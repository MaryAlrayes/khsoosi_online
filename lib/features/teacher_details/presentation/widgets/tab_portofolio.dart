...
class TabPortofolio extends StatelessWidget {
  ...
  Widget _buildCard(int index,BuildContext context) {
    return InkWell(
      onTap: (){
        Navigator.pushNamed(context, TeacherPortofolioDetailsScreen.routeName,arguments: {'portofolio':portofolio[index],'details':teacherDetailsEntity});
      },
      child: Card(
        elevation: 1,
