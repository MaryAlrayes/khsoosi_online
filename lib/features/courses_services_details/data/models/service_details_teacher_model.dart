...
import 'package:khosousi_online/features/courses_services_details/domain/entities/course_service_details_teacher_entity.dart';

class ServiceDetailsTeacherModel extends CourseServiceDetailsTeacherEntity {
  ServiceDetailsTeacherModel(
  ...
  factory ServiceDetailsTeacherModel.fromJson(
    Map<String, dynamic> map,
    int coursesCount,
    double? averageRate,
  ) {
    return ServiceDetailsTeacherModel(
      teacherId: map['Id'] ?? "",
      name: map['Name'] ?? '',
