...
class TeacherCoursesScreen extends StatelessWidget {
  ...
  Text _buildNumberCourses() => Text('عدد الدورات: 6');
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                'دورة راسبيري باي Raspberry Pi و لغة البرمجة python',
              ...
              Text(
                'برمجة بايثون-دارات الكترونية-راسبيري باي',
