...
class UserInfoModel extends UserInfoEntity {
  UserInfoModel({
    ...
    required super.countryOfResidenseId,
  ...
  Map<String, dynamic> toJson() {
    return <String, dynamic>{
      ...
      'Country_of_residense_id':countryOfResidenseId,
  ...
  factory UserInfoModel.fromJson(Map<String, dynamic> map) {
    return UserInfoModel(
      ...
      countryOfResidenseId: map['Country_of_residense_id']??'',
  ...
  UserInfoModel copyWith({
    ...
    return UserInfoModel(
      ...
      countryOfResidenseId:countryOfResidenseId??this.countryOfResidenseId,
      lat: lat ?? this.lat,
      lng: lng ?? this.lng,
