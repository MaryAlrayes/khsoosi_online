...
import 'package:khosousi_online/features/accounts/presentation/profile_info/institute/widgets/institute_phones_step.dart';
import 'package:khosousi_online/features/accounts/presentation/profile_info/institute/widgets/institute_general_info_step.dart';
import 'package:khosousi_online/features/accounts/presentation/profile_info/institute/widgets/institute_details_step.dart';
import 'package:khosousi_online/features/accounts/presentation/profile_info/institute/widgets/institute_categories_step.dart';
import 'package:khosousi_online/features/accounts/presentation/profile_info/institute/widgets/institute_location_step.dart';
import 'package:khosousi_online/features/accounts/presentation/profile_info/institute/widgets/institute_upload_image_step.dart';
...
class InstituteInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var stepsWidget = [
      InstitutePhonesStep(countries: countries),
      InstituteGeneralInfoStep(countries: countries),
      InstituteDetailsStep(),
      InstituteCaregoriesStep(),
      InstituteLocationStep(),
      InstituteUploadImageStep(),
    ];
